...
def create_model_cls(model_cfg: ModelConfig, weight_path: Union[bool, Path] = True, class_num: int = 80) -> YOLO_CLS:
    ...
    model = YOLO_CLS(model_cfg, class_num)
    if weight_path:
        # if weight_path == True:
